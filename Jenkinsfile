pipeline {
    ...
    stages {
        ...
        stage('Update Deployment File') {
            steps {
                script {
                    def gitUrl = "https://ranjanniket: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@github.com/ranjanniket/bran_manifest.git"
